...
describe("parseInput", function() {
  it('["-lineCount","file1"]', function() {
    ...
    expectedOutput = { err : "" ,fileNames: ["file1"], options: ["lineCount"]};
    assert.deepEqual(parseInputs(userInput), expectedOutput);
  });

  it('["-w","file1"]', function() {
    let userInput = ["-w", "file1"];
    expectedOutput = { err : "",fileNames: ["file1"], options: ["wordCount"]};
    assert.deepEqual(parseInputs(userInput), expectedOutput);
  });

  it('["-c","file1"]', function() {
    let userInput = ["-c", "file1"];
    expectedOutput = {err:"", fileNames: ["file1"], options: ["characterCount"]};
    assert.deepEqual(parseInputs(userInput), expectedOutput);
  });
  ...
  it('["file1"]', function() {
    ...
    expectedOutput = {err:"", fileNames: ["file1"], options: ["lineCount", "wordCount", "characterCount"]};
    assert.deepEqual(parseInputs(userInput), expectedOutput);
  });
  it('["file1","file2"]', function() {
    let userInput = ["file1", "file2"];

    expectedOutput = {err:"", fileNames: ["file1", "file2"], options: ["lineCount", "wordCount", "characterCount"]};
    assert.deepEqual(parseInputs(userInput), expectedOutput);
  });
  it('["-lw","file1"]', function() {
    let userInput = ["-lw", "file1"];
    expectedOutput = {err:"", fileNames: ["file1"], options: ["lineCount", "wordCount"]};
    assert.deepEqual(parseInputs(userInput), expectedOutput);
  });
  ...
  it('["-cl","file1"]', function() {
    ...
    expectedOutput = {err:"", fileNames: ["file1"], options: [ "lineCount" , "characterCount"]};
    assert.deepEqual(parseInputs(userInput), expectedOutput);
  });
  ...
  it('["-wc","file1"]', function() {
    ...
    expectedOutput = {err:"", fileNames: ["file1"], options: ["wordCount", "characterCount"]};
    assert.deepEqual(parseInputs(userInput), expectedOutput);
  });
